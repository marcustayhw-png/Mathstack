      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 py-12 md:py-20">
        ...
        <div className="mb-10 md:mb-12 space-y-4">
          ...
          <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed">
            Every key formula organised by topic. <span className="text-primary font-bold">Exam Sheet</span> formulas are provided in the official GCE O-Level exam.
          </p>
        </div>
        ...
        <div className="sticky top-0 z-20 bg-background/90 backdrop-blur-md border-b border-border/40 -mx-4 sm:-mx-6 md:-mx-8 px-4 sm:px-6 md:px-8 py-3 mb-8 space-y-3">
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div className="flex gap-1.5 p-1 bg-muted/40 rounded-full border border-border/50">
              {([
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-full bg-muted/40 border border-border/50 text-sm font-medium placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50 transition-all"
              />
              {search && (
                <button
                  onClick={() => setSearch("")}
        ...
        <div className="mb-8 p-4 md:p-5 rounded-2xl border border-primary/20 bg-primary/5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <Link
            href="/formulas/sheet"
            className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-primary text-primary-foreground text-xs font-bold hover:shadow-md hover:-translate-y-0.5 transition-all shrink-0 whitespace-nowrap"
          >
