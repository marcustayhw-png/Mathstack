      ...
      <AnimatePresence mode="wait">
        ...
        {step === "level" && (
          <motion.div key="level" {...popIn} className="space-y-10">
            <div className="space-y-1.5">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">Pick your level and we&apos;ll show you the right notes.</p>
            </div>
        ...
        {step === "chapter" && (
          <motion.div key="chapter" {...slideIn} className="space-y-8">
            <div className="space-y-1.5">
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">What are you working on?</h2>
              <p className="text-muted-foreground text-sm leading-relaxed">Select a chapter to see its notes.</p>
            </div>
