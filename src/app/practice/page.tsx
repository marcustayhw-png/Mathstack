...
export const metadata = {
  title: "Practice | Satori Education Studio",
        ...
        <div className="mb-14 space-y-6 md:mb-16">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-base leading-relaxed text-muted-foreground md:text-lg">
              Past-paper style questions with full worked solutions — organised with the same calm, structured flow as the rest of Satori Education Studio.
            </p>
          </div>
          <div className="flex flex-wrap gap-3 pt-1">
            {["Sec 1 & 2", "Sec 3 & 4", "E Math", "A Math", "Worked Solutions"].map((tag) => (
